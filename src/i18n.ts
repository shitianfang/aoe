...
const ZH: Record<string, string> = {
  ...
  "create failed": "创建失败",
  "an agent named {n} is already here": "已经有一个叫 {n} 的智能体了",
  "creating…": "创建中…",
  "names use a–z, 0–9, - and _": "名字只能用 a–z、0–9、- 和 _",
  "names starting with master are reserved": "以 master 开头的名字是保留的",
  "delete agent": "删除智能体",
  delete: "删除",
  "delete failed": "删除失败",
  ...
  "drawn on a standard {w}×{h} screen": "按 {w}×{h} 标准屏渲染",
  "back to the zoom that fits": "回到自动适应的比例",
  smaller: "缩小",
  bigger: "放大",
